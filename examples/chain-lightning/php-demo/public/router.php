...
// Serve Chain Lightning client script from dist
if (preg_match('#^/\.chain-lightning/.+\.js$#', $uri)) {
    ...
    http_response_code(404);
    echo 'Chain Lightning asset not found';
    exit;
}
...
// Only serve index.php for the root path
if ($uri === '/') {
